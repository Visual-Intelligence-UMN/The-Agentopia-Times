...
export class ParentScene extends Phaser.Scene {
    ...
    private scoreText: string = 'No Score Available';
                ...
                onEnd={() => {
                    ...
                    const handleSpacePress = () => {
                        ...
                        if (mode === 'prompt') player.addPromptUtils(innerText);
                            ...
                            player.setInstruction(innerText);
    ...
    protected onOverlapEnd(player: any, item: any) {
        console.log(
            `Agent ${player.getName()} exited ${item.texture.key} zone.`,
        );

        if (state.isTypewriting) {
            state.isTypewriting = false;
            console.log(
                'Reset state.isTypewriting because Agent exited item zone.',
            );
        }
    }
